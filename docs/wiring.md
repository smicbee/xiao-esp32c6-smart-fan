...
The editable [KiCad 9 schematic](../hardware/xiao-esp32c6-smart-fan.kicad_sch) is the design source. A [PDF version](diagrams/circuit-schematic.pdf) is available for printing and offline reference.
